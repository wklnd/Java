...
Km/h. Omvandlingsfaktorn är 1.852.
...
public class KnotToKph{
    public static void main(String[] args) {
        ...
        float knotSpeed = scanner.nextFloat(); // Tar in input som en float
        System.out.println(knotSpeed + " knop motsvarar " + (knotSpeed * 1.852F) + " km/h"); // Skriver ut resultatet
